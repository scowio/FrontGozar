...
export default function ConfigBox({ config }) {
  ...
  return (
    <div className="p-3 w-[376px] h-[82px] bg-[#1F222A] flex flex-col items-center justify-center rounded-[16px]">
      <div className="w-[344px] h-[50px] flex items-center justify-center gap-4 rounded">
